 ...
 */
@annotation.annotationAnd(featureName = "NodoIndice")
public class NodoIndice implements java.lang.Comparable<uniandes.cupi2.biblioteca.mundo.implementacion1.NodoIndice> {
     ...
     */
    @annotation.annotationFeature(featureName = "darLlave", parent = "NodoIndice")
     ...
     */
    @annotation.annotationFeature(featureName = "compararNodo", parent = "NodoIndice")
     ...
     */
    @annotation.annotationFeature(featureName = "indexarLibro", parent = "NodoIndice")
     ...
     */
    @annotation.annotationFeature(featureName = "darLibros", parent = "NodoIndice")
