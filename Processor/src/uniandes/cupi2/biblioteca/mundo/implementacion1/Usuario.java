 ...
 */
@annotationAnd(featureName="Usuario", mandaroty=true)
public class Usuario implements IUsuario, Serializable
{
     ...
     */
    @annotationFeature(featureName="alquilarLibro", parent="Usuario")
    @annotationExtends(origen="alquilarLibro", destino="Libro")
     ...
     */
    @annotationFeature(featureName="devolverLibro", parent="Usuario")
    @annotationExtends(origen="devolverLibro", destino="Libro")
     ...
     */
    @annotationFeature(featureName="darNombre", parent="Usuario")
     ...
     */
    @annotationFeature(featureName="darLogin", parent="Usuario")
     ...
     */
    @annotationFeature(featureName="darClave", parent="Usuario")
     ...
     */
    @annotationFeature(featureName="darLibrosAlquilados", parent="Usuario")
    @annotationExtends(origen="darLibrosAlquilados", destino="Libro")
     ...
     */
    @annotationFeature(featureName="asignarLibrosAlquilados", parent="Usuario")
    @annotationExtends(origen="asignarLibrosAlquilados", destino="Libro")
