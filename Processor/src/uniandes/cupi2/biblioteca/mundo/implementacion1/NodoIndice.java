 ...
 */
@annotationAnd(featureName="NodoIndice")
public class NodoIndice implements Comparable<NodoIndice>
{
    ...
    @annotationFeature(featureName="darLlave", parent="NodoIndice")
     ...
     */
    @annotationFeature(featureName="compararNodo", parent="NodoIndice")
     ...
     */
    @annotationFeature(featureName="indexarLibro", parent="NodoIndice")
     ...
     */
    @annotationFeature(featureName="darLibros", parent="NodoIndice")
